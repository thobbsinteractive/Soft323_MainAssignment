...
void PSystem::preRender()
{
	...
	localDevice->SetRenderState(D3DRS_POINTSIZE, fToDw(size));
	localDevice->SetRenderState(D3DRS_POINTSIZE_MIN, fToDw(0.0f));

	// control the size of the particle relative to distance
	localDevice->SetRenderState(D3DRS_POINTSCALE_A, fToDw(0.0f));
	localDevice->SetRenderState(D3DRS_POINTSCALE_B, fToDw(0.0f));
	localDevice->SetRenderState(D3DRS_POINTSCALE_C, fToDw(1.0f));
}
